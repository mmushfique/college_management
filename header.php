            ...
            <?php
                ...
                if(!empty($_SESSION["role"])){
                  //This echo is to call the username and role
                        ...
                        echo "<li><a href='#' class='active'> Welcome&nbsp;<b> " .$_SESSION["user"]."</b></a></li>" ;
                    ...
                    if(($_SESSION["role"])=="ADMIN"){
                      ...
                      //echo for the LECTURER pages only
                        ...
                        echo "<li><a href='lecturerViewGrade.php'>Filter results</a></li>";
                        echo "<li><a href='LecturerChangePW.php'>PWD Change</a></li>";
                    }
                  ...
                  // echo if not logged in
                    echo  "<li><a href='index.php' style='--i:1;' class='active'>Home</a></li>
                           <li><a href='Blog.php' style='--i:2;'>Blog</a></li>
                           <li><a href='about.php' style='--i:3;'>About</a></li>
                           <li><a href='Contact_us.php' style='--i:4;'>Contact us</a></li>
